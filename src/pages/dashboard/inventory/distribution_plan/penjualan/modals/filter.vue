          ...
          <div class="modal-header">
            ...
            <div class="modal-body pt-3">
              ...
              <div class="form-group">
                ...
                <selectize v-model="dataFilter.depo" data-placeholder="Pilih Depo" :settings="selectizeConfig" required :disabled="request">
              ...
              <div class="form-group">
                ...
                <selectize v-model="dataFilter.tipe_pembayaran" data-placeholder="Tipe Pembaayaran">
