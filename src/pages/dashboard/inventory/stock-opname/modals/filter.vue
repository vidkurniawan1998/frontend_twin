        ...
        <div class="modal-content">
          ...
          <div class="modal-body pt-3">
            <div class="form-group">
              ...
              <selectize v-model="dataFilter.gudang" data-placeholder="Pilih Gudang" required :disabled="gudang.length == 0 ? true : false">
            ...
            <div class="form-group">
              ...
              <selectize v-model="dataFilter.status" data-placeholder="Pilih Status" required>
                <option :value="d" v-for="(d, i) in ['all', 'waiting', 'approved']" :key="i">
                  {{ d }}
                </option>
              </selectize>
            </div>
...
<style lang="scss" src="../stock-opname.scss" scoped />
