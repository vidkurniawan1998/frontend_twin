        ...
        <div class="modal-content">
          ...
          <div class="modal-body pt-3">
            <div class="form-group">
              <label for="" class="form-label">Mutasi Dari</label>
              <selectize v-model="dataFilter.dari" data-placeholder="Pilih Gudang" required :disabled="gudang.length == 0 ? true : false">
                <option :value="d.id" v-for="(d, i) in gudang" :key="i"> {{ d.nama_gudang }} </option>
              </selectize>
            </div>

            <div class="form-group">
              <label for="" class="form-label">Mutasi Ke</label>
              <selectize v-model="dataFilter.ke" data-placeholder="Pilih Gudang" required :disabled="gudang.length == 0 ? true : false">
                <option :value="d.id" v-for="(d, i) in gudang" :key="i"> {{ d.nama_gudang }} </option>
              </selectize>
            </div>
            ...
            <div class="form-group">
              ...
              <selectize v-model="dataFilter.status" data-placeholder="Pilih Status" required>
                <option :value="d" v-for="(d, i) in ['all', 'waiting', 'approved', 'on the way', 'received']" :key="i"> {{ d }} </option>
              </selectize>
            </div>
