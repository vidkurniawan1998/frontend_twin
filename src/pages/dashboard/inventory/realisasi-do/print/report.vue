                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="font-size: 18px">
                                                    <b style="font-weight: bold">{{dataOri.nama_perusahaan}} (Depo : {{dataOri.depo}}) </b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="smaller-text">
                                                       Sales Accumulative Report By Item
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td valign="top" width="20%" style="font-size: 16px">
                                        <table>
                                            <tr>
                                                <td><b style="font-weight: bold">Driver : {{dataOri.driver}}</b></td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-12">
                            <table style="width: 100%; font-size: 16px" class="table-border">
                                <thead>
                                    <tr class=" nowrap" >
                                        <th colspan="1" rowspan="2" style="vertical-align : middle;text-align:center; width: 20%" >DSKU</th>
                                        <th colspan="1" rowspan="2" style="vertical-align : middle;text-align:center; width: 40%" >Kode Barang</th>
                                 ...
                                 <template  v-for="(row) in data" >
                                    ...
                                    <tr class="detail" style="border-bottom: 1px solid black; border-collapse: collapse; ">
                                        ...
                                        <td style="width: 10px !important">{{val.kode_barang}} &nbsp;&nbsp;&nbsp; {{val.nama_barang}}</td>
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-12">
                            <table class="text-left" style="width: 100%">
                                ...
                                <tr>
                                    <td style="width: 10%"> <strong>Total.Invoice: </strong></td>
...
import helper from "@/assets/js/helper.js";
    ...
    export default {
        ...
        methods: {
            getData(){
                let relisasi_do = JSON.parse(localStorage.reportRekapitulasiDO),
                data = relisasi_do.detail;
                this.data = data;
                this.dataOri = relisasi_do;

                var formatted_date = new Date().toJSON().slice(0,10).replace(/-/g,'/');
                document.title = 'RealisasiDO'+formatted_date+' - PRINT'
