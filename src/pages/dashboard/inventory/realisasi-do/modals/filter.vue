            ...
            <div class="modal-body pt-3">
              <div class="row">
                <div class="form-group col-12">
                  ...
                  <selectize id="depo" v-model="dataFilter.depo" data-placeholder="Pilih Depo" required :disabled="request">
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input type="date" class="form-control" required v-model="dataFilter.start_date">
                </div>
