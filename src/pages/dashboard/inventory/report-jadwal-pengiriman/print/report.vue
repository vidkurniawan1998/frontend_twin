                                            ...
                                            <tr>
                                                <td>
                                                    <span class="smaller-text">
                                                       Driver Accumulative Report By Item
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <thead>
                                 ...
                                 <template  v-for="(row) in data" >
                                    ...
                                    <tr class="detail" style="border-bottom: 1px solid black; border-collapse: collapse; ">
                                        ...
                                        <td style="width: 10px !important">{{val.kode_barang}}</td>
                                        <td colspan="2" style="width: 50% ; text-align:left !important">{{val.nama_barang}}</td>
                                        <td class="text-center">{{val.tipe_harga.toUpperCase()}}</td>
...
import helper from "@/assets/js/helper.js";
    ...
    export default {
        ...
        methods: {
            getData(){
                let jadwal_pengiriman = JSON.parse(localStorage.reportJadwalPengiriman), 
                data = jadwal_pengiriman.detail;
                this.data = data;
                this.dataOri = jadwal_pengiriman;

                var formatted_date = new Date().toJSON().slice(0,10).replace(/-/g,'/');
                document.title = 'JadwalPengiriman'+formatted_date+' - PRINT'
