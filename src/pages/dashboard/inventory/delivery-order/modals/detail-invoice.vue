                      ...
                      <div class="row">
                        <div class="col-6">
                          ...
                          <div class="form-group">
                            ...
                            <input v-model="formData.qty" type="tel" onfocus="this.select()" required @keypress="numberOnly($event)" maxlength="11" class="form-control" placeholder="Qty dus">
                          </div>
                        ...
                        <div class="col-6">
                          ...
                          <div class="form-group">
                            ...
                            <input v-model="formData.qty_pcs" type="tel" onfocus="this.select()" required @keypress="numberOnly($event)" maxlength="11" class="form-control" placeholder="Qty pcs">
                          </div>
...
<style lang="scss" src="../delivery.scss" scoped/>