        ...
        <div class="modal-content">
          ...
          <div class="modal-body pt-3">
            <div class="form-group">
              ...
              <input type="date" class="form-control" v-model="data.due_date">
            </div>
          </div>

          <div class="modal-footer">
            <button type="button" class="btn btn-white" @click="close()" v-html="'Tutup'" />
            <button type="button" class="btn btn-primary" @click="submit" v-html="'Ubah Due Date'" />
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      request: true,
      data: {
        due_date: this.initData ? this.initData.due_date : this.dateTime('ymd')
      }
    };
  },
  ...
  watch: {
    ...
    initData: function(form) {
      this.data.due_date = form.due_date
    },
