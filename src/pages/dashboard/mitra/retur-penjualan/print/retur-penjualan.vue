                                        ...
                                        <table style="width: 100%; text-align: right">
                                            <tr>
                                                <td>
                                                    ...
                                                    <span v-html="header.id+''+(header.no_retur_manual == '' || header.no_retur_manual == null ? '' : ' ('+header.no_retur_manual+')')"></span> <br> <span v-html="dFormat(header.sales_retur_date,'dMY')"></span>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table style="width: 100%; font-size: 16px" class="table-border">
                                ...
                                <tbody>
                                    <tr v-for="(row, i) in details" :key="i" class="detail">
                                        ...
                                        <!-- KATEGORI -->
                                        <td v-html="header.status === 'waiting' && header.id_perusahaan == 1 ? '' : row.kategori_bs"></td>

                                        <!-- TANGGAL EXPIRED -->
                                        <td v-html="header.status === 'waiting' && header.id_perusahaan == 1 ? '' : dateFormat(row.expired_date)"></td>
