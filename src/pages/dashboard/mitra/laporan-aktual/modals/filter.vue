            ...
            <div class="modal-body pt-3">
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input id="mulai-tanggal" type="date" class="form-control" required v-model="dataFilter.start_date">
                </div>

                <div class="form-group col-6">
                  <label for="sampai-tanggal" class="form-label">Sampai Tanggal</label>
                  <input id="sampai-tanggal" type="date" class="form-control" required v-model="dataFilter.end_date" :min="dataFilter.start_date">
                </div>
              </div>
