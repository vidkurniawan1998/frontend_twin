...
import PrintInvoice from "./modals/print-pelunasan.vue";
import FormFilter from "./modals/filter-pelunasan.vue";
...
export default {
  ...
  methods: {
    ...
    _createPdf(){
      if(this.dataFilter.tipe == 'all' || this.dataFilter.tipe == '')
      {
        let doc = new jsPDF('l','mm',[1189, 841]), user = JSON.parse(localStorage.user);
