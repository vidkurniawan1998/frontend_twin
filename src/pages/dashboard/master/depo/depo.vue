<template>
  <div class="antialiased">
    ...
    <div class="page">
      ...
      <Header @change="_search" hint="Ketik nama depo"/>
...
import FormDepo from "./modals/form-depo.vue";
...
export default {
  ...
  methods: {
      ...
      _get(params){
        ...
        this.axios.get('depo?per_page='+this.paginate.perPage+'&page='+this.paginate.currentPage+'&keyword='+this.dataFilter.keyword).then(res => {
          this.loading = false;
      ...
      _add(data){
        this.form.config = {view: true, title: 'Tambah Depo'}
        this.form.data = null
        this.form.action = (formData) => {

          this.axios.post("depo", formData).then(() => {
      ...
      _edit(data){
        this.form.config = {view: true, title: 'Edit Depo'}
        this.form.data = data
        this.form.action = (formData) => {

          this.axios.put("depo/"+data.id, formData).then(() => {
      ...
      _search(keyword){
        ...
        //   if(this.data[i].nama_depo.toLowerCase().includes(k)){
