<template>
  <div class="antialiased">
    ...
    <div class="page">
      ...
      <Header @change="_search" hint="Ketik nama tim"/>
...
import FormTim from "./modals/form-tim.vue";
...
export default {
  ...
  methods: {
      ...
      _get(params){
        ...
        this.axios.get('tim?per_page='+this.paginate.perPage+'&page='+this.paginate.currentPage+'&keyword='+this.dataFilter.keyword).then(res => {
          this.loading = false;
      ...
      _add(data){
        this.form.config = {view: true, title: 'Tambah Tim'}
        this.form.data = null
        this.form.action = (formData) => {

          this.axios.post("tim", formData).then(() => {
      ...
      _edit(data){
        this.form.config = {view: true, title: 'Edit Tim'}
        this.form.data = data
        this.form.action = (formData) => {

          this.axios.put("tim/"+data.id, formData).then(() => {
            this._get({silent: true})
      ...
      _delete(id){
        this.confirm.id = id
        this.confirm.title = 'Yakin ingin menghapus data tim ini?'
        this.confirm.action = () => {
          this.axios.delete('tim/'+id).then( () => {
