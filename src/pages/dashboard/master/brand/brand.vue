<template>
  <div class="antialiased">
    ...
    <div class="page">
      ...
      <Header @change="_search" hint="Ketik nama brand"/>
...
import FormBrand from "./modals/form-brand.vue";
...
export default {
  ...
  methods: {
      ...
      _get(params){
        ...
        this.axios.get('brand?per_page='+this.paginate.perPage+'&page='+this.paginate.currentPage+'&keyword='+this.dataFilter.keyword).then(res => {
          this.loading = false;
      ...
      _add(){
        this.form.config = {view: true, title: 'Tambah Brand'}
        this.form.data = null
        this.form.action = (formData) => {

          this.axios.post('brand', formData).then(res =>{
      ...
      _edit(data){
        this.form.config = {view: true, title: 'Edit Brand'}
        this.form.data = data
        this.form.action = (formData) => {

          this.axios.put('brand/'+data.id+'?per_page='+this.paginate.perPage+'&page='+this.paginate.currentPage, formData).then(res =>{
      ...
      _search(keyword){
        ...
        //   if(this.data[i].nama_brand.toLowerCase().includes(k)){
