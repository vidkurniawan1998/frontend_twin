          ...
          <form @submit.prevent="submit">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <label class="form-check form-check-inline" v-for="(d, i) in ['wbp','rbp','hcobp']" :key="i">
                  <input class="form-check-input" type="radio" name="th" :value="d" v-model="data.tipe_harga">
                  <span class="form-check-label" v-html="d"/>
                </label>
              </div>
