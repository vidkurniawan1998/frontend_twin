              ...
              <div class="row mt-3">
                <div class="col-md-4">
                  <div class="form-group" ref="sales">
                    ...
                    <selectize v-model="id_salesman" data-placeholder="Pilih Salesman" required :disabled="loading">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" required v-model="tanggal" ref="date">
                  </div>
                </div>
                ...
                <div class="col-auto"> <label for="" class="form-label">&nbsp;</label>
              ...
              <div class="card">
                <div class="table-respon sive">
                  <table class="table table-vcenter table-hover card-table table-striped">
                    ...
                    <tbody>
                      <tr v-for="(row, i) in filter" :key="i" @click="_check(row.id)" style="cursor: default" :class="{'text-primary': row.id_mitra }">
...
export default {
  ...
  methods: {
    ...
    _get(){
      ...
      this.axios.get('pelunasan_penjualan?per_page=all&id_salesman='+this.id_salesman+'&status=belum_lunas&hari='+hari).then(res => {
        this.loading = false;
