          ...
          <form @submit.prevent="submit">
            <div class="modal-body">
              <div class="form-group">
                ...
                <input id="tanggal" type="date" class="form-control" v-model="data.tanggal" required>
              </div>

              <div class="form-group">
                <label for="toko" class="form-label">Toko</label>
                <selectize id="toko" data-placeholder="Pilih Toko" v-model="data.id_toko">
              ...
              <div class="form-group">
                ...
                <textarea id="keterangan" class="form-control" rows="5" v-model="data.keterangan" placeholder="Keterangan"></textarea>
              </div>
...
export default {
  ...
  methods: {
    ...
    _getToko(id_tim) {
      this.getListToko({id_tim: id_tim}).then( res => {
        this.toko = res
      })
    }
  },
    ...
    "config.view": function(view) {
      if (view) {
        ...
        setTimeout(() => {
          ...
          this._getToko(this.data.id_tim)
        }, 100);
      } else {
        this.modal.open = view;
        setTimeout(() => {
