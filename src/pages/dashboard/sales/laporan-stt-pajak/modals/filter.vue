            ...
            <div class="modal-body pt-3">
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <selectize id="perusahaan" v-model="dataFilter.id_perusahaan" data-placeholder="Pilih Perusahaan" required @input="_getDepo($event)" :disabled="loading">
              ...
              <div class="form-group">
                ...
                <label class="form-check form-check-inline" v-for="(d, i) in ['all','exclude','include']" :key="i">
                  <input class="form-check-input" type="radio" name="nomor_pajak" :value="d" v-model="dataFilter.nomor_pajak">
              ...
              <div class="form-group">
                ...
                <label class="form-check form-check-inline" v-for="(d, i) in ['all','approved','delivered', 'cancel']" :key="i">
...
export default {
  ...
  mounted: function () {
    ...
    this.$watch('dataFilter.id_perusahaan', function (value) {
