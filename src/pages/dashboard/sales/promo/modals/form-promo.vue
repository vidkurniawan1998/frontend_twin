          ...
          <form @submit.prevent="submit">
            <div class="modal-body" ref="modal">
              <div class="form-group">
                <label for="" class="form-label">No Proposal</label>
                <input type="text" class="form-control" placeholder="Nomor Proposal" v-model="data.no_promo" required ref="focus">
              </div>

              <div class="form-group">
                <label for="" class="form-label">Nama Promo</label>
                <input type="text" class="form-control" placeholder="Nama promo" v-model="data.nama_promo" required>
              </div>
              ...
              <div class="form-group">
                <label for="" class="form-label">Status Klaim</label>
                <label class="form-check form-check-inline" v-for="(d, i) in ['Belum','Sudah']" :key="i">
                  <input class="form-check-input" type="radio" name="status_klaim" :value="i" v-model="data.status_klaim">
                  <span class="form-check-label" v-html="ucwords(d.split('_').join(' '))"/>
                </label>
              </div>
