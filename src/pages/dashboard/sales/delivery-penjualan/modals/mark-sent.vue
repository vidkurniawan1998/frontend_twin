        ...
        <div class="modal-content">
          ...
          <div class="modal-body pt-3">
            <div class="form-group">
              ...
              <input type="date" class="form-control" v-model="data.delivery_at" id="tanggal">
            </div>
          </div>

          <div class="modal-footer">
            <button type="button" class="btn btn-white" @click="close()" v-html="'Tutup'" />
            <button type="button" class="btn btn-primary" @click="submit" v-html="'Tandai Sebagai Terkirim'" />
          </div>
