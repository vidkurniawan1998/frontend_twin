          ...
          <div class="modal-body pt-3 pb-0" style="min-height: 350px">
            ...
            <div style="line-height: 17px" class="mb-4">
              ...
              <div class="info-header mt-3">
                ...
                <div class="mb-1">
                  NPWP
                  <span class="click-able">{{ formatNpwp(retur.npwp) }}</span>
                </div>
                <div class="mb-1">
                  Gudang
                ...
                <div class="mb-1" v-if="retur.faktur_pajak_pembelian=='' || retur.faktur_pajak_pembelian==null ? false : true">
                  No Faktur Pajak Pembelian
                  <span class="click-able">{{ retur.faktur_pajak_pembelian }}</span>
                </div>
                <div class="mb-1"  v-if="retur.faktur_pajak_pembelian=='' || retur.faktur_pajak_pembelian==null ? false : true">
                  Tanggal Terbit Faktur Pajak Pembelian
                  <span class="click-able">{{ retur.tanggal_faktur_pajak_pembelian }}</span>
                </div>
              </div>
                  ...
                  <table class="table table-v center table-hover card-table table-striped table-no-break">
                    ...
                    <tbody>
                      ...
                      <tr v-for="(row, i) in detail_retur" v-if="!loading">
                        ...
                        <td>
                            {{ row.nama_barang }}
                            <span :class="row.tipe_barang == 'non_exist' ? 'bg-success badge' : row.tipe_barang == 'exist' ? 'bg-danger badge' : 'bg-primary badge'">
                              {{row.tipe_barang}}
                            </span>
                        </td>
