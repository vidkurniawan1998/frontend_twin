          ...
          <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="form-group" v-else>
                ...
                <input id="nama-toko" type="text" readonly v-model="nama_toko" class="form-control" placeholder="Inputkan nama toko">
              </div>

              <div class="form-group">
                <label for="tanggal" class="form-label">Tanggal</label>
                <input id="tanggal" type="date" class="form-control" v-model="data.sales_retur_date" required>
              </div>

              <div class="form-group">
                <label class="form-label">Tiper Retur Barang</label>
              ...
              <div class="form-group">
                ...
                <input id="potongan" type="number" class="form-control" v-model="data.potongan" required>
              </div>
